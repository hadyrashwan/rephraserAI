...
const createFloatingPopup = function createFloatingPopup(x, y) {
  if (floatingPopup) {
    document.body.removeChild(floatingPopup);
  }
...
const showFloatingPopupListener = function showFloatingPopupListener() {
  return (message, sender, sendResponse) => {
    if (
      message.action === "showFloatingPopup" ||
      message.action === "showApiResponse"
    ) {
